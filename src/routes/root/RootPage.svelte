<script lang="ts">
  ...
  import { aboutMe, myEmail, myUrls, skillsStack, skillsStackAdditional } from "../../data/about";
        ...
        <div class="flex flex-col gap-6 mt-2 text-foreground/90">
            ...
            <section class="mt-4">
                ...
                <div class="flex flex-row flex-wrap gap-2">
                    {#each skillsStackAdditional as skill}
                      <Badge label={skill} />
                    {/each}
                </div>
            </section>
            ...
            <section class="flex flex-col" hidden={true}>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm mt-2">
                    <div class="p-3 border rounded-lg bg-card/30">
                        <h3 class="font-semibold text-muted-foreground mb-2 text-xs uppercase tracking-wider">
                            Workstations
                        </h3>
            ...
            <section class="mt-4">
                <div class="flex flex-row gap-2 text-muted-foreground">
                    <p>version {(globalThis as any).APP_VERSION}</p>
                    <!-- | -->
